...
static int x=140, y=90, dx=1, dy=0, pts=0, x1=160, y1=90, dx1=1, dy1=0, pts1=0, tempsActuel = 0, tempsPrecedent = 0, pointeur = 0, tour=0, check = 0, winner = 0, inser=0, speed=2, difficulty=2, print=0, bonus=0;
